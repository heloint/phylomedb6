...
import { createNewHelpGuide } from "../add/_actions";
...
export default function AddGuideForm() {
    ...
    const [state, formAction] = useFormState(createNewHelpGuide, initialState);
    const [newGuideContent, setNewGuideContent] = useState<string>("");
                    ...
                    <div>
                     ...
                     whitespace-pre-wrap"
                            ...
                            <RichTextEditor
                                ...
                                setContent={setNewGuideContent}
                            />

                            <input
                                data-cy="text-editor-input"
                                type="hidden"
                                name="content"

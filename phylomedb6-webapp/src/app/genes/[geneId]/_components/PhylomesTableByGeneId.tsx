...
export default function PhylomesTableByGeneId({
    phylomeData,
}: {
    ...
    border-solid m-1 hover:border-slate-700"
            >
                <button className="flex gap-4 items-center justify-center h-10 w-10">
    ...
    return (
        <>
            <div className="flex flex-col my-3 pt-4 w-full bg-white bg-opacity-60 rounded-lg">
                <div className=" px-5 md:px-10 lg:px-20  ">
                    <div className="py-1 bg-white bg-opacity-75 rounded-lg">
                        <div className="py-3 md:pl-10 lg:pl-12 sm:flex-row justify-center items-center p-4 sm:p-0">
                            <h1 className="text-2xl font-semibold underline decoration-solid">
                                Phylomes containing this gene
                            </h1>
                            <p>
                                <i>

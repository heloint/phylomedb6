...
print(
    "\n\n comparison of models M1 and M2, p-value: "
    + str(tree.get_most_likely("M2", "M1"))
)
...
model2.set_histface(
    up=False, kind="stick", hlines=[1.0, 0.3], hlines_col=["black", "grey"]
)
tree.show(histfaces=["M2"])
...
model2.set_histface(
    up=False, kind="bar", colors=col, hlines=[1.0, 0.3], hlines_col=["black", "grey"]
)
...
print(
    "\n\n comparison of models M7 and M8, p-value: "
    + str(tree.get_most_likely("M8", "M7"))
)
print(
    "\n\n comparison of models M8a and M8, p-value: "
    + str(tree.get_most_likely("M8", "M8a"))
)

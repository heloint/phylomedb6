...
class Test_gtdbquery(unittest.TestCase):
    ...
    def test_00_update_database(self):
        ...
        url = (
            "https://github.com/etetoolkit/ete-data/raw/main"
            "/gtdb_taxonomy/gtdb202/gtdb202dump.tar.gz"
        )

        print(
            f"Downloading GTDB database release 202 to {DEFAULT_GTDBTAXADUMP} from {url}"
        )
    ...
    def test_01tree_annotation(self):
        tree = PhyloTree(
            "((c__Alicyclobacillia, c__Bacilli), s__Caballeronia udeis);",
        ...
        self.assertEqual(
            firmicutes.props.get("named_lineage"),
        ...
        self.assertEqual(
            caballeronia.props.get("named_lineage"),
            [
                "root",
                "d__Bacteria",
                "p__Proteobacteria",
    ...
    def test_02tree_annotation(self):
        ...
        tree = PhyloTree(
            "((GB_GCA_011358815.1,RS_GCF_003948265.1),(GB_GCA_003344655.1),(GB_GCA_011056255.1));",
            sp_naming_function=lambda name: name,
        )
        ...
        self.assertEqual(
            cryptofilum.props.get("sci_name"), "s__Korarchaeum cryptofilum"
        )
        self.assertEqual(cryptofilum.props.get("rank"), "species")
        self.assertEqual(
            cryptofilum.props.get("named_lineage"),
            [
                "root",
                "d__Archaea",
                "p__Thermoproteota",
        ...
        self.assertEqual(
            sp003344655.props.get("sci_name"), "s__Korarchaeum sp003344655"
        )
        self.assertEqual(sp003344655.props.get("rank"), "subspecies")
        self.assertEqual(
            sp003344655.props.get("named_lineage"),
            [
                "root",
                "d__Archaea",
                "p__Thermoproteota",
    ...
    def test_03tree_annotation(self):
        ...
        tree = PhyloTree(
            "((GB_GCA_011358815.1|protA,RS_GCF_003948265.1|protB),(GB_GCA_003344655.1|protC),(GB_GCA_011056255.1|protD));",
    ...
    def test_gtdbquery(self):
        ...
        self.assertEqual(
            ...
            set(
                [
                    ...
                    "GB_GCA_003345595.1",
                    "g__SMTZ1-45",
                    "s__SMTZ1-45 sp001940705",
                    "GB_GCA_001940705.1",
                    "s__SMTZ1-45 sp001563335",
                    "GB_GCA_001563335.1",
                    "s__SMTZ1-45 sp011364905",
                    "GB_GCA_011364905.1",
                    "s__SMTZ1-45 sp004376265",
                    "GB_GCA_004376265.1",
                    "s__SMTZ1-45 sp002825515",
                    "GB_GCA_002825515.1",
                    "g__SMTZ1-83",
                    "s__SMTZ1-83 sp001563325",
                    "GB_GCA_001563325.1",
                    "s__SMTZ1-83 sp011364985",
                    "GB_GCA_011364985.1",
                    "s__SMTZ1-83 sp011365025",
                    "GB_GCA_011365025.1",
                    "g__MP8T-1",
                    "s__MP8T-1 sp004524565",
                    "GB_GCA_004524565.1",
                    "s__MP8T-1 sp004524595",
                    "GB_GCA_004524595.1",
                    "s__MP8T-1 sp002825465",
                    "GB_GCA_002825465.1",
                    "s__MP8T-1 sp002825535",
                    "GB_GCA_002825535.1",
                    "s__MP8T-1 sp003345545",
                    "GB_GCA_003345545.1",
                    "g__TEKIR-14",
                    "s__TEKIR-14 sp004524445",
                    "GB_GCA_004524445.1",
                    "g__JACAEL01",
                    "s__JACAEL01 sp013388835",
                    "GB_GCA_013388835.1",
                    "g__SHMX01",
                    "s__SHMX01 sp008080745",
                    "GB_GCA_008080745.1",
                    "g__TEKIR-12S",
                    "s__TEKIR-12S sp004524435",
                    "GB_GCA_004524435.1",
                    "g__WTCK01",
                    "s__WTCK01 sp013138615",
                    "GB_GCA_013138615.1",
                ]
            ),
        )
        ...
        out = gtdb.get_descendant_taxa(
            "c__Thorarchaeia", intermediate_nodes=False, rank_limit="species"
        )
    ...
    def test_get_rank(self):
        ...
        self.assertEqual(
            ranks, {"c__Thorarchaeia": "class", "RS_GCF_001477695.1": "subspecies"}
        )
    ...
    def test_ignore_unclassified(self):
        ...
        # check nomarl leaf
        self.assertEqual(
            t["GB_GCA_011364985.1"].props.get("taxid"), "GB_GCA_011364985.1"
        )
        self.assertEqual(
            t["GB_GCA_011364985.1"].props.get("sci_name"), "s__SMTZ1-83 sp011364985"
        )

...
AVAIL = {
    ...
    "fb_anc": {
        ...
        "exec": "codeml",
        "allow_mark": False,
        "changes": [("model", 1), ("RateAncestor", 1), ("NSsites", 0)],
    },
    "b_free": {
        "typ": "branch",
        "evol": "positive-selection",
    ...
    "b_neut": {
        ...
        "exec": "codeml",
        "allow_mark": True,
        "changes": [("model", 2), ("NSsites", 0), ("fix_omega", 1), ("omega", 1)],
    },
    "bsA1": {
        "typ": "branch-site",
        "evol": "relaxation",
    ...
    "bsA": {
        ...
        "exec": "codeml",
        "allow_mark": True,
        "changes": [("model", 2), ("NSsites", 2), ("omega", 1.7), ("ncatG", "*")],
    },
    "bsB": {
        "typ": "branch-site",
        "evol": "positive-selection",
        "exec": "codeml",
        "allow_mark": True,
        "changes": [("model", 2), ("NSsites", 3), ("omega", 1.7), ("ncatG", "*")],
    },
    "bsC": {
        "typ": "branch-site",
        "evol": "different-ratios",
        "exec": "codeml",
        "allow_mark": True,
        "changes": [("model", 3), ("NSsites", 2), ("ncatG", 3)],
    },
    "bsD": {
        "typ": "branch-site",
        "evol": "different-ratios",
        "exec": "codeml",
        "allow_mark": True,
        "changes": [("model", 3), ("NSsites", 3), ("ncatG", 3)],
    },
    "SLR": {
        "typ": "site",
        "evol": "positive/negative selection",
        "exec": "Slr",
        "sep": "= ",
        "allow_mark": False,
        "changes": [
            (x[0], "*") for x in [x for x in list(PARAMS.items()) if "file" not in x[0]]
        ]
        + [("positive_only", "0")],
    },
}

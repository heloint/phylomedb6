...
class Ui_Dialog:
    ...
    def retranslateUi(self, Dialog):
        ...
        self.leaves_only.setText(
            QApplication.translate("Dialog", "Search only for leaf nodes", None)
        )
        ...
        self.attrType.setItemText(
            7, QApplication.translate("Dialog", "matches this regular expression", None)
        )
        self.label.setText(
            QApplication.translate(
                "Dialog", "Search nodes whose                                ", None
            )
        )

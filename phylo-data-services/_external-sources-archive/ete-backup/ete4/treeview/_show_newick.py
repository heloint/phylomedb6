...
class Ui_Newick:
    ...
    def retranslateUi(self, Newick):
        ...
        self.label_3.setText(
            QApplication.translate("Newick", "Node's attribute (NHX format)", None)
        )
        self.useAllFeatures.setText(
            QApplication.translate("Newick", "Include all attributes in nodes", None)
        )

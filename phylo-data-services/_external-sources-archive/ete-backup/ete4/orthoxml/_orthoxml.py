    ...
    def exportAttributes(
            ...
            outfile.write(
                ...
                % (
                    self.gds_format_string(
                        quote_attrib(self.origin), input_name="origin"
                    ),
                )
            )
        ...
        if self.originVersion is not None and "originVersion" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_format_string(
                        quote_attrib(self.originVersion), input_name="originVersion"
                    ),
                )
            )
    ...
    def exportAttributes(
        ...
        if (
            ...
            outfile.write(
                ...
                % (
                    self.gds_format_string(
                        quote_attrib(self.transcriptLink), input_name="transcriptLink"
                    ),
                )
            )
        if self.protLink is not None and "protLink" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_format_string(
                        quote_attrib(self.protLink), input_name="protLink"
                    ),
                )
            )
        if self.geneLink is not None and "geneLink" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_format_string(
                        quote_attrib(self.geneLink), input_name="geneLink"
                    ),
                )
            )
        if self.name is not None and "name" not in already_processed:
    ...
    def exportAttributes(
        ...
        if self.protId is not None and "protId" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_format_string(
                        quote_attrib(self.protId), input_name="protId"
                    ),
                )
            )
        ...
        if self.geneId is not None and "geneId" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_format_string(
                        quote_attrib(self.geneId), input_name="geneId"
                    ),
                )
            )
        if self.transcriptId is not None and "transcriptId" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_format_string(
                        quote_attrib(self.transcriptId), input_name="transcriptId"
                    ),
                )
            )
...
class scoreDef(GeneratedsSuper):
    ...
    def exportAttributes(
        ...
        if self.desc is not None and "desc" not in already_processed:
            ...
            outfile.write(
                " desc=%s"
                % (self.gds_format_string(quote_attrib(self.desc), input_name="desc"),)
            )

...
class Phyloxml(GeneratedsSuper):
    ...
    def set_phylogeny(self, phylogeny):
        self.phylogeny = phylogeny

    def add_phylogeny(self, value):
        self.phylogeny.append(value)

    def insert_phylogeny(self, index, value):
        self.phylogeny[index] = value

    def export(
        self, outfile, level, namespace_="phy:", name_="Phyloxml", namespacedef_=""
    ):
        showIndent(outfile, level)
        outfile.write(
            "<%s%s%s"
        ...
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_="Phyloxml"
        )
        if self.hasContent_():
            outfile.write(">\n")
...
class Phylogeny(GeneratedsSuper):
    ...
    def insert_confidence(self, index, value):
    ...
    def get_clade_relation(self):
        return self.clade_relation

    def set_clade_relation(self, clade_relation):
        self.clade_relation = clade_relation

    def add_clade_relation(self, value):
        self.clade_relation.append(value)

    def insert_clade_relation(self, index, value):
        self.clade_relation[index] = value

    def get_sequence_relation(self):
        return self.sequence_relation

    def set_sequence_relation(self, sequence_relation):
        self.sequence_relation = sequence_relation

    def add_sequence_relation(self, value):
        self.sequence_relation.append(value)

    def insert_sequence_relation(self, index, value):
        self.sequence_relation[index] = value
    ...
    def get_rerootable(self):
        return self.rerootable

    def set_rerootable(self, rerootable):
        self.rerootable = rerootable

    def get_branch_length_unit(self):
        return self.branch_length_unit

    def set_branch_length_unit(self, branch_length_unit):
    ...
    def set_rooted(self, rooted):
        self.rooted = rooted

    def export(
        self, outfile, level, namespace_="phy:", name_="Phylogeny", namespacedef_=""
    ):
        showIndent(outfile, level)
        outfile.write(
            "<%s%s%s"
        ...
        already_processed = []
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_="Phylogeny"
        )
        if self.hasContent_():
            outfile.write(">\n")
            self.exportChildren(outfile, level + 1, namespace_, name_)
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespace_="phy:", name_="Phylogeny"
    ):
        if self.rerootable is not None and "rerootable" not in already_processed:
            ...
            outfile.write(
                ...
                % self.gds_format_boolean(
                    self.gds_str_lower(str(self.rerootable)), input_name="rerootable"
                )
            )
        if (
            self.branch_length_unit is not None
            and "branch_length_unit" not in already_processed
        ):
            already_processed.append("branch_length_unit")
            outfile.write(
                " branch_length_unit=%s"
                % (
                    self.gds_format_string(
                        quote_attrib(self.branch_length_unit).encode(ExternalEncoding),
                        input_name="branch_length_unit",
                    ),
                )
            )
        if self.type_ is not None and "type_" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_format_string(
                        quote_attrib(self.type_).encode(ExternalEncoding),
                        input_name="type",
                    ),
                )
            )
        if self.rooted is not None and "rooted" not in already_processed:
            ...
            outfile.write(
                ' rooted="%s"'
                % self.gds_format_boolean(
                    self.gds_str_lower(str(self.rooted)), input_name="rooted"
                )
            )

    def exportChildren(
        self, outfile, level, namespace_="phy:", name_="Phylogeny", fromsubclass_=False
    ):
        ...
        if self.description is not None:
            ...
            outfile.write(
                ...
                % (
                    namespace_,
                    self.gds_format_string(
                        quote_xml(self.description).encode(ExternalEncoding),
        ...
        if self.date is not None:
            ...
            outfile.write(
                ...
                % (
                    namespace_,
                    self.gds_format_string(
                        quote_xml(self.date).encode(ExternalEncoding), input_name="date"
                    ),
                    namespace_,
                )
            )
        ...
        for sequence_relation_ in self.sequence_relation:
            sequence_relation_.export(
                outfile, level, namespace_, name_="sequence_relation"
            )
    ...
    def hasContent_(self):
        if (
            ...
            or self.confidence
            or self.clade is not None
            or self.clade_relation
            or self.sequence_relation
            or self.property
        ):
            return True
        else:
...
class Clade(GeneratedsSuper):
    ...
    def insert_taxonomy(self, index, value):
    ...
    def insert_sequence(self, index, value):
    ...
    def get_binary_characters(self):
        return self.binary_characters

    def set_binary_characters(self, binary_characters):
        self.binary_characters = binary_characters
    ...
    def insert_distribution(self, index, value):
    ...
    def add_clade(self, value):
        self.clade.append(value)

    def insert_clade(self, index, value):
        self.clade[index] = value

    def get_id_source(self):
        return self.id_source

    def set_id_source(self, id_source):
        self.id_source = id_source

    def get_branch_length_attr(self):
        return self.branch_length_attr

    def set_branch_length_attr(self, branch_length_attr):
        self.branch_length_attr = branch_length_attr

    def export(
        self, outfile, level, namespace_="phy:", name_="Clade", namespacedef_=""
    ):
        showIndent(outfile, level)
        outfile.write(
            "<%s%s%s"
        ...
        already_processed = []
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_="Clade"
        )
        if self.hasContent_():
            outfile.write(">\n")
            self.exportChildren(outfile, level + 1, namespace_, name_)
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespace_="phy:", name_="Clade"
    ):
        ...
        if (
            self.branch_length_attr is not None
            and "branch_length_attr" not in already_processed
        ):
            already_processed.append("branch_length_attr")
            outfile.write(
                " branch_length_attr=%s"
                % (
                    self.gds_format_string(
                        quote_attrib(self.branch_length_attr).encode(ExternalEncoding),
                        input_name="branch_length_attr",
                    ),
                )
            )

    def exportChildren(
        self, outfile, level, namespace_="phy:", name_="Clade", fromsubclass_=False
    ):
        if self.name is not None:
            showIndent(outfile, level)
            outfile.write(
        ...
        if self.branch_length is not None:
            showIndent(outfile, level)
            outfile.write(
                "<%sbranch_length>%s</%sbranch_length>\n"
                % (
                    namespace_,
                    self.gds_format_double(
                        self.branch_length, input_name="branch_length"
                    ),
                    namespace_,
                )
            )
        ...
        if self.width is not None:
            ...
            outfile.write(
                ...
                % (
                    namespace_,
                    self.gds_format_double(self.width, input_name="width"),
                    namespace_,
                )
            )
        if self.color:
        ...
        if self.binary_characters:
            self.binary_characters.export(
                outfile, level, namespace_, name_="binary_characters"
            )
    ...
    def hasContent_(self):
        if (
            self.name is not None
            or self.branch_length is not None
            or self.confidence
            ...
            or self.binary_characters is not None
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.binary_characters is not None:
            ...
            self.binary_characters.exportLiteral(
                outfile, level, name_="binary_characters"
            )
            showIndent(outfile, level)
            outfile.write("),\n")
        showIndent(outfile, level)
...
class Taxonomy(GeneratedsSuper):
    ...
    def add_common_name(self, value):
        self.common_name.append(value)

    def insert_common_name(self, index, value):
        self.common_name[index] = value
    ...
    def insert_synonym(self, index, value):
    ...
    def export(
        ...
        already_processed = []
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_="Taxonomy"
        )
        if self.hasContent_():
            outfile.write(">\n")
            self.exportChildren(outfile, level + 1, namespace_, name_)
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespace_="phy:", name_="Taxonomy"
    ):
        if self.id_source is not None and "id_source" not in already_processed:
            already_processed.append("id_source")
            outfile.write(" id_source=%s" % (quote_attrib(self.id_source),))
    ...
    def exportChildren(
        self, outfile, level, namespace_="phy:", name_="Taxonomy", fromsubclass_=False
    ):
        if self.id:
            self.id.export(outfile, level, namespace_, name_="id")
        if self.code is not None:
            ...
            outfile.write(
                ...
                % (
                    namespace_,
                    self.gds_format_string(
                        quote_xml(self.code).encode(ExternalEncoding), input_name="code"
                    ),
                    namespace_,
                )
            )
        if self.scientific_name is not None:
            showIndent(outfile, level)
            outfile.write(
                "<%sscientific_name>%s</%sscientific_name>\n"
                % (
                    namespace_,
                    self.gds_format_string(
                        quote_xml(self.scientific_name).encode(ExternalEncoding),
        ...
        if self.authority is not None:
            showIndent(outfile, level)
            outfile.write(
                "<%sauthority>%s</%sauthority>\n"
                % (
                    namespace_,
                    self.gds_format_string(
                        quote_xml(self.authority).encode(ExternalEncoding),
        ...
        for common_name_ in self.common_name:
            showIndent(outfile, level)
            outfile.write(
                "<%scommon_name>%s</%scommon_name>\n"
                % (
                    namespace_,
                    self.gds_format_string(
                        quote_xml(common_name_).encode(ExternalEncoding),
        ...
        for synonym_ in self.synonym:
            ...
            outfile.write(
                ...
                % (
                    namespace_,
                    self.gds_format_string(
                        quote_xml(synonym_).encode(ExternalEncoding),
                        input_name="synonym",
                    ),
                    namespace_,
                )
        ...
        if self.rank is not None:
            ...
            outfile.write(
                ...
                % (
                    namespace_,
                    self.gds_format_string(
                        quote_xml(self.rank).encode(ExternalEncoding), input_name="rank"
                    ),
                    namespace_,
                )
            )
    ...
    def hasContent_(self):
        if (
            ...
            or self.scientific_name is not None
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == "id":
            ...
            scientific_name_ = re_.sub(
                STRING_CLEANUP_PAT, " ", scientific_name_
            ).strip()
            scientific_name_ = self.gds_validate_string(
                scientific_name_, node, "scientific_name"
            )
            ...
            if common_name_:
                ...
                common_name_ = self.gds_validate_string(
                    common_name_, node, "common_name"
                )
...
class Sequence(GeneratedsSuper):
    ...
    def get_mol_seq(self):
        return self.mol_seq

    def set_mol_seq(self, mol_seq):
        self.mol_seq = mol_seq
    ...
    def insert_annotation(self, index, value):
        self.annotation[index] = value

    def get_domain_architecture(self):
        return self.domain_architecture

    def set_domain_architecture(self, domain_architecture):
        self.domain_architecture = domain_architecture
    ...
    def export(
        self, outfile, level, namespace_="phy:", name_="Sequence", namespacedef_=""
    ):
        showIndent(outfile, level)
        outfile.write(
            "<%s%s%s"
        ...
        already_processed = []
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_="Sequence"
        )
        if self.hasContent_():
            outfile.write(">\n")
            self.exportChildren(outfile, level + 1, namespace_, name_)
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespace_="phy:", name_="Sequence"
    ):
        if self.id_source is not None and "id_source" not in already_processed:
            already_processed.append("id_source")
            outfile.write(" id_source=%s" % (quote_attrib(self.id_source),))
    ...
    def exportChildren(
        self, outfile, level, namespace_="phy:", name_="Sequence", fromsubclass_=False
    ):
        if self.symbol is not None:
            ...
            outfile.write(
                ...
                % (
                    namespace_,
                    self.gds_format_string(
                        quote_xml(self.symbol).encode(ExternalEncoding),
                        input_name="symbol",
                    ),
                    namespace_,
                )
        ...
        if self.location is not None:
            ...
            outfile.write(
                ...
                % (
                    namespace_,
                    self.gds_format_string(
                        quote_xml(self.location).encode(ExternalEncoding),
                        input_name="location",
                    ),
                    namespace_,
                )
        ...
        if self.domain_architecture:
            self.domain_architecture.export(
                outfile, level, namespace_, name_="domain_architecture"
            )

    def hasContent_(self):
        if (
            self.symbol is not None
            or self.accession is not None
            or self.name is not None
            or self.location is not None
            or self.mol_seq is not None
            or self.uri is not None
            or self.annotation
            or self.domain_architecture is not None
        ):
            return True
        else:
            return False
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.domain_architecture is not None:
            ...
            self.domain_architecture.exportLiteral(
                outfile, level, name_="domain_architecture"
            )
            showIndent(outfile, level)
            outfile.write("),\n")
...
class MolSeq(GeneratedsSuper):
    ...
    def get_is_aligned(self):
        return self.is_aligned

    def set_is_aligned(self, is_aligned):
    ...
    def export(
        self, outfile, level, namespace_="phy:", name_="MolSeq", namespacedef_=""
    ):
        showIndent(outfile, level)
        outfile.write(
            "<%s%s%s"
        ...
        already_processed = []
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_="MolSeq"
        )
        if self.hasContent_():
            outfile.write(">")
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespace_="phy:", name_="MolSeq"
    ):
        if self.is_aligned is not None and "is_aligned" not in already_processed:
            ...
            outfile.write(
                ' is_aligned="%s"'
                % self.gds_format_boolean(
                    self.gds_str_lower(str(self.is_aligned)), input_name="is_aligned"
                )
            )

    def exportChildren(
        self, outfile, level, namespace_="phy:", name_="MolSeq", fromsubclass_=False
    ):
        pass
...
class Accession(GeneratedsSuper):
    ...
    def export(
        self, outfile, level, namespace_="phy:", name_="Accession", namespacedef_=""
    ):
        showIndent(outfile, level)
        outfile.write(
            "<%s%s%s"
        ...
        already_processed = []
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_="Accession"
        )
        if self.hasContent_():
            outfile.write(">")
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespace_="phy:", name_="Accession"
    ):
    ...
    def exportChildren(
        self, outfile, level, namespace_="phy:", name_="Accession", fromsubclass_=False
    ):
        pass
...
class DomainArchitecture(GeneratedsSuper):
    ...
    def insert_domain(self, index, value):
    ...
    def export(
        ...
        already_processed = []
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_="DomainArchitecture"
        )
        if self.hasContent_():
            outfile.write(">\n")
            self.exportChildren(outfile, level + 1, namespace_, name_)
...
class ProteinDomain(GeneratedsSuper):
    ...
    def export(
        self, outfile, level, namespace_="phy:", name_="ProteinDomain", namespacedef_=""
    ):
        showIndent(outfile, level)
        outfile.write(
            "<%s%s%s"
        ...
        already_processed = []
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_="ProteinDomain"
        )
        if self.hasContent_():
            outfile.write(">")
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
...
class Events(GeneratedsSuper):
    ...
    def get_speciations(self):
        return self.speciations

    def set_speciations(self, speciations):
        self.speciations = speciations
    ...
    def export(
        self, outfile, level, namespace_="phy:", name_="Events", namespacedef_=""
    ):
        showIndent(outfile, level)
        outfile.write(
            "<%s%s%s"
        ...
        already_processed = []
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_="Events"
        )
        if self.hasContent_():
            outfile.write(">\n")
            self.exportChildren(outfile, level + 1, namespace_, name_)
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespace_="phy:", name_="Events"
    ):
        pass

    def exportChildren(
        self, outfile, level, namespace_="phy:", name_="Events", fromsubclass_=False
    ):
        if self.type_ is not None:
            ...
            outfile.write(
                ...
                % (
                    namespace_,
                    self.gds_format_string(
                        quote_xml(self.type_).encode(ExternalEncoding),
                        input_name="type",
                    ),
                    namespace_,
                )
        ...
        if self.duplications is not None:
            showIndent(outfile, level)
            outfile.write(
                "<%sduplications>%s</%sduplications>\n"
                % (
                    namespace_,
                    self.gds_format_integer(
                        self.duplications, input_name="duplications"
                    ),
                    namespace_,
                )
            )
        if self.speciations is not None:
            showIndent(outfile, level)
            outfile.write(
                "<%sspeciations>%s</%sspeciations>\n"
                % (
                    namespace_,
                    self.gds_format_integer(self.speciations, input_name="speciations"),
                    namespace_,
                )
            )
        if self.losses is not None:
            ...
            outfile.write(
                ...
                % (
                    namespace_,
                    self.gds_format_integer(self.losses, input_name="losses"),
                    namespace_,
                )
            )
        if self.confidence:
    ...
    def hasContent_(self):
        if (
            ...
            or self.duplications is not None
            or self.speciations is not None
            or self.losses is not None
...
class BinaryCharacters(GeneratedsSuper):
    ...
    def set_lost_count(self, lost_count):
    ...
    def get_gained_count(self):
        return self.gained_count

    def set_gained_count(self, gained_count):
    ...
    def export(
        ...
        already_processed = []
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_="BinaryCharacters"
        )
        if self.hasContent_():
            outfile.write(">\n")
            self.exportChildren(outfile, level + 1, namespace_, name_)
    ...
    def exportAttributes(
        ...
        if self.lost_count is not None and "lost_count" not in already_processed:
            ...
            outfile.write(
                ' lost_count="%s"'
                % self.gds_format_integer(self.lost_count, input_name="lost_count")
            )
        if self.absent_count is not None and "absent_count" not in already_processed:
            already_processed.append("absent_count")
            outfile.write(
                ' absent_count="%s"'
                % self.gds_format_integer(self.absent_count, input_name="absent_count")
            )
        if self.present_count is not None and "present_count" not in already_processed:
            ...
            outfile.write(
                ' present_count="%s"'
                % self.gds_format_integer(
                    self.present_count, input_name="present_count"
                )
            )
        if self.type_ is not None and "type_" not in already_processed:
            already_processed.append("type_")
        ...
        if self.gained_count is not None and "gained_count" not in already_processed:
            ...
            outfile.write(
                ' gained_count="%s"'
                % self.gds_format_integer(self.gained_count, input_name="gained_count")
            )
    ...
    def hasContent_(self):
        if (
            self.gained is not None
            or self.lost is not None
            or self.present is not None
            or self.absent is not None
        ):
            return True
        else:
            return False
...
class BinaryCharacterList(GeneratedsSuper):
    ...
    def add_bc(self, value):
        self.bc.append(value)

    def insert_bc(self, index, value):
        self.bc[index] = value
    ...
    def export(
        ...
        already_processed = []
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_="BinaryCharacterList"
        )
        if self.hasContent_():
            outfile.write(">\n")
            self.exportChildren(outfile, level + 1, namespace_, name_)
        ...
        for bc_ in self.bc:
            ...
            outfile.write(
                ...
                % (
                    namespace_,
                    self.gds_format_string(
                        quote_xml(bc_).encode(ExternalEncoding), input_name="bc"
                    ),
                    namespace_,
                )
            )
...
class Reference(GeneratedsSuper):
    ...
    def export(
        self, outfile, level, namespace_="phy:", name_="Reference", namespacedef_=""
    ):
        showIndent(outfile, level)
        outfile.write(
            "<%s%s%s"
        ...
        already_processed = []
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_="Reference"
        )
        if self.hasContent_():
            outfile.write(">\n")
            self.exportChildren(outfile, level + 1, namespace_, name_)
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespace_="phy:", name_="Reference"
    ):
    ...
    def exportChildren(
        self, outfile, level, namespace_="phy:", name_="Reference", fromsubclass_=False
    ):
        if self.desc is not None:
            ...
            outfile.write(
                ...
                % (
                    namespace_,
                    self.gds_format_string(
                        quote_xml(self.desc).encode(ExternalEncoding), input_name="desc"
                    ),
                    namespace_,
                )
            )
...
class Annotation(GeneratedsSuper):
    ...
    def export(
        self, outfile, level, namespace_="phy:", name_="Annotation", namespacedef_=""
    ):
        showIndent(outfile, level)
        outfile.write(
            "<%s%s%s"
        ...
        already_processed = []
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_="Annotation"
        )
        if self.hasContent_():
            outfile.write(">\n")
            self.exportChildren(outfile, level + 1, namespace_, name_)
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespace_="phy:", name_="Annotation"
    ):
        if self.source is not None and "source" not in already_processed:
            already_processed.append("source")
            outfile.write(
        ...
        if self.evidence is not None and "evidence" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_format_string(
                        quote_attrib(self.evidence).encode(ExternalEncoding),
                        input_name="evidence",
                    ),
                )
            )
    ...
    def exportChildren(
        self, outfile, level, namespace_="phy:", name_="Annotation", fromsubclass_=False
    ):
        if self.desc is not None:
            showIndent(outfile, level)
            outfile.write(
...
class Property(GeneratedsSuper):
    ...
    def set_applies_to(self, applies_to):
    ...
    def export(
        self, outfile, level, namespace_="phy:", name_="Property", namespacedef_=""
    ):
        showIndent(outfile, level)
        outfile.write(
            "<%s%s%s"
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespace_="phy:", name_="Property"
    ):
    ...
    def exportChildren(
        self, outfile, level, namespace_="phy:", name_="Property", fromsubclass_=False
    ):
        pass
...
class Uri(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_="phy:", name_="Uri", namespacedef_=""):
        ...
        already_processed = []
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_="Uri"
        )
        if self.hasContent_():
            outfile.write(">")
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespace_="phy:", name_="Uri"
    ):
        if self.type_ is not None and "type_" not in already_processed:
            already_processed.append("type_")
            outfile.write(
    ...
    def exportChildren(
        self, outfile, level, namespace_="phy:", name_="Uri", fromsubclass_=False
    ):
        pass
...
class Confidence(GeneratedsSuper):
    ...
    def export(
        self, outfile, level, namespace_="phy:", name_="Confidence", namespacedef_=""
    ):
        showIndent(outfile, level)
        outfile.write(
            "<%s%s%s"
        ...
        already_processed = []
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_="Confidence"
        )
        if self.hasContent_():
            outfile.write(">")
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespace_="phy:", name_="Confidence"
    ):
        if self.type_ is not None and "type_" not in already_processed:
            already_processed.append("type_")
            outfile.write(
    ...
    def exportChildren(
        self, outfile, level, namespace_="phy:", name_="Confidence", fromsubclass_=False
    ):
        pass
...
class Id(GeneratedsSuper):
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespace_="phy:", name_="Id"
    ):
        if self.provider is not None and "provider" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_format_string(
                        quote_attrib(self.provider).encode(ExternalEncoding),
                        input_name="provider",
                    ),
                )
            )
    ...
    def exportChildren(
        self, outfile, level, namespace_="phy:", name_="Id", fromsubclass_=False
    ):
        pass
...
class Distribution(GeneratedsSuper):
    ...
    def insert_point(self, index, value):
    ...
    def export(
        self, outfile, level, namespace_="phy:", name_="Distribution", namespacedef_=""
    ):
        showIndent(outfile, level)
        outfile.write(
            "<%s%s%s"
        ...
        already_processed = []
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_="Distribution"
        )
        if self.hasContent_():
            outfile.write(">\n")
            self.exportChildren(outfile, level + 1, namespace_, name_)
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespace_="phy:", name_="Distribution"
    ):
        pass
    ...
    def hasContent_(self):
        if self.desc is not None or self.point or self.polygon:
            return True
        else:
            return False
...
class Point(GeneratedsSuper):
    ...
    def get_geodetic_datum(self):
        return self.geodetic_datum

    def set_geodetic_datum(self, geodetic_datum):
        self.geodetic_datum = geodetic_datum

    def get_alt_unit(self):
        return self.alt_unit

    def set_alt_unit(self, alt_unit):
        self.alt_unit = alt_unit

    def export(
        self, outfile, level, namespace_="phy:", name_="Point", namespacedef_=""
    ):
        showIndent(outfile, level)
        outfile.write(
            "<%s%s%s"
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespace_="phy:", name_="Point"
    ):
        if (
            self.geodetic_datum is not None
            and "geodetic_datum" not in already_processed
        ):
            ...
            outfile.write(
                ...
                % (
                    self.gds_format_string(
                        quote_attrib(self.geodetic_datum).encode(ExternalEncoding),
                        input_name="geodetic_datum",
                    ),
                )
            )
        if self.alt_unit is not None and "alt_unit" not in already_processed:
            ...
            outfile.write(
                ...
                % (
                    self.gds_format_string(
                        quote_attrib(self.alt_unit).encode(ExternalEncoding),
                        input_name="alt_unit",
                    ),
                )
            )
    ...
    def exportChildren(
        self, outfile, level, namespace_="phy:", name_="Point", fromsubclass_=False
    ):
        if self.lat is not None:
            ...
            outfile.write(
                ...
                % (
                    namespace_,
                    self.gds_format_float(self.lat, input_name="lat"),
                    namespace_,
                )
            )
        if self.long is not None:
            ...
            outfile.write(
                ...
                % (
                    namespace_,
                    self.gds_format_float(self.long, input_name="long"),
                    namespace_,
                )
            )
        if self.alt is not None:
            ...
            outfile.write(
                ...
                % (
                    namespace_,
                    self.gds_format_float(self.alt, input_name="alt"),
                    namespace_,
                )
            )

    def hasContent_(self):
        if self.lat is not None or self.long is not None or self.alt is not None:
            return True
        else:
            return False
...
class Polygon(GeneratedsSuper):
    ...
    def export(
        self, outfile, level, namespace_="phy:", name_="Polygon", namespacedef_=""
    ):
        showIndent(outfile, level)
        outfile.write(
            "<%s%s%s"
        ...
        already_processed = []
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_="Polygon"
        )
        if self.hasContent_():
            outfile.write(">\n")
            self.exportChildren(outfile, level + 1, namespace_, name_)
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespace_="phy:", name_="Polygon"
    ):
        pass

    def exportChildren(
        self, outfile, level, namespace_="phy:", name_="Polygon", fromsubclass_=False
    ):
        for point_ in self.point:
            point_.export(outfile, level, namespace_, name_="point")
...
class Date(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_="phy:", name_="Date", namespacedef_=""):
        ...
        already_processed = []
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_="Date"
        )
        if self.hasContent_():
            outfile.write(">\n")
            self.exportChildren(outfile, level + 1, namespace_, name_)
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespace_="phy:", name_="Date"
    ):
        if self.unit is not None and "unit" not in already_processed:
            already_processed.append("unit")
            outfile.write(
                ...
                % (
                    self.gds_format_string(
                        quote_attrib(self.unit).encode(ExternalEncoding),
                        input_name="unit",
                    ),
                )
            )
    ...
    def exportChildren(
        self, outfile, level, namespace_="phy:", name_="Date", fromsubclass_=False
    ):
        if self.desc is not None:
            showIndent(outfile, level)
            outfile.write(
        ...
        if self.value is not None:
            ...
            outfile.write(
                ...
                % (
                    namespace_,
                    self.gds_format_float(self.value, input_name="value"),
                    namespace_,
                )
            )
        if self.minimum is not None:
            ...
            outfile.write(
                ...
                % (
                    namespace_,
                    self.gds_format_float(self.minimum, input_name="minimum"),
                    namespace_,
                )
            )
        if self.maximum is not None:
            ...
            outfile.write(
                ...
                % (
                    namespace_,
                    self.gds_format_float(self.maximum, input_name="maximum"),
                    namespace_,
                )
            )
...
class BranchColor(GeneratedsSuper):
    ...
    def export(
        self, outfile, level, namespace_="phy:", name_="BranchColor", namespacedef_=""
    ):
        showIndent(outfile, level)
        outfile.write(
            "<%s%s%s"
        ...
        already_processed = []
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_="BranchColor"
        )
        if self.hasContent_():
            outfile.write(">\n")
            self.exportChildren(outfile, level + 1, namespace_, name_)
    ...
    def exportAttributes(
        self, outfile, level, already_processed, namespace_="phy:", name_="BranchColor"
    ):
        pass
    ...
    def exportChildren(
        ...
        if self.red is not None:
            ...
            outfile.write(
                ...
                % (
                    namespace_,
                    self.gds_format_integer(self.red, input_name="red"),
                    namespace_,
                )
            )
        if self.green is not None:
            ...
            outfile.write(
                ...
                % (
                    namespace_,
                    self.gds_format_integer(self.green, input_name="green"),
                    namespace_,
                )
            )
        if self.blue is not None:
            ...
            outfile.write(
                ...
                % (
                    namespace_,
                    self.gds_format_integer(self.blue, input_name="blue"),
                    namespace_,
                )
            )

    def hasContent_(self):
        if self.red is not None or self.green is not None or self.blue is not None:
            return True
        else:
            return False
...
class SequenceRelation(GeneratedsSuper):
    ...
    def get_id_ref_0(self):
        return self.id_ref_0

    def set_id_ref_0(self, id_ref_0):
        self.id_ref_0 = id_ref_0

    def get_id_ref_1(self):
        return self.id_ref_1

    def set_id_ref_1(self, id_ref_1):
    ...
    def export(
        ...
        already_processed = []
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_="SequenceRelation"
        )
        if self.hasContent_():
            outfile.write(">\n")
            self.exportChildren(outfile, level + 1, namespace_, name_)
    ...
    def exportAttributes(
        ...
        if self.distance is not None and "distance" not in already_processed:
            ...
            outfile.write(
                ' distance="%s"'
                % self.gds_format_double(self.distance, input_name="distance")
            )
...
class CladeRelation(GeneratedsSuper):
    ...
    def export(
        self, outfile, level, namespace_="phy:", name_="CladeRelation", namespacedef_=""
    ):
        showIndent(outfile, level)
        outfile.write(
            "<%s%s%s"
        ...
        already_processed = []
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_="CladeRelation"
        )
        if self.hasContent_():
            outfile.write(">\n")
            self.exportChildren(outfile, level + 1, namespace_, name_)

...
def populate_main_args(main_args_p):
    ...
    main_args.add_argument(
        "-o", dest="output", type=str, help="""Base output file name"""
    )
    ...
    main_args.add_argument(
        ...
        default=2,
        help=(
            "Verbosity level: 0=totally quite, 1=errors only,"
...
def populate_source_args(source_args_p):
    ...
    source_args.add_argument(
        "--src_attr_parser",
        dest="src_attr_parser",
        type=str,
        help=(
            "Perl regular expression wrapping the portion of the target attribute that should be used."
        ),
    )

    source_args.add_argument(
        "--src_tree_format", dest="src_newick_format", type=int, default=0
    )
...
def populate_ref_args(ref_args_p):
    ...
    ref_args.add_argument(
        "--ref_tree_format", dest="ref_newick_format", type=int, default=0
    )

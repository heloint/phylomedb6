...
def populate_args(mod_args_p):
    ...
    mod_args.add_argument(
        ...
        nargs="+",
        help=(
            "Root the tree using the provided outgroup."
    ...
    mod_args.add_argument(
        ...
        default="-1",
        help=(
            "Convert tree into ultrametric (all leaves have the same distance"
    ...
    mod_args.add_argument(
        ...
        dest="prune_preserve_lengths",
        action="store_true",
        help=(
            "branch lengths of the removed nodes are added to the kept branches, "
            "thus preserving original tree length."
        ),
    )

    mod_args.add_argument(
        "--unroot", dest="unroot", action="store_true", help="Unroots the tree."
    )

...
DATAPATH = (
    os.path.abspath(os.path.split(os.path.realpath(__file__))[0]) + "/ete_evol_data/"
)
...
class TestEvolEvolTree(unittest.TestCase):
    ...
    def test_load_model(self):
        ...
        self.assertEqual(
            sorted(tree._models.keys()), sorted(["fb", "M1", "M2", "M7", "M8"])
        )
    ...
    def test_get_most_likely(self):
        ...
        tree.link_to_evol_model(WRKDIR + "paml/M2/M2.out", "M2")
        self.assertEqual(
            round(tree.get_most_likely("M2", "M1"), 16),
    ...
    def test_deep_copy(self):
        ...
        self.assertEqual(
            str(tree.get_evol_model("fb.a")), str(tree.get_evol_model("fb"))
        )
    ...
    def test_call_histface(self):
        ...
        try:
            ...
            self.assertEqual(
                str(type(M2a.properties["histface"])),
    ...
    def test_marking_trees(self):
        ...
        tree.mark_tree(
            [x.props.get("node_id") for x in tree.get_descendants()],
    ...
    def test_pickling(self):
        ...
        tree2_output = hashlib.md5(
            str(tree2.get_evol_model("M2.a")).encode()
        ).hexdigest()

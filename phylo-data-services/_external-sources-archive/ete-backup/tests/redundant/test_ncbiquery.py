...
class Test_ncbiquery(unittest.TestCase):
    ...
    def test_02tree_annotation(self):
        ...
        t = PhyloTree(
            "((9598|protA, 9606|protB), 10090|propC);",
    ...
    def test_ncbiquery(self):
        ...
        self.assertEqual(
            set(out), {9606, 63221, 741158, 1425170, 2665952, 2665953, 2813598, 2813599}
        )

        out = ncbi.get_descendant_taxa("9605", intermediate_nodes=False)
        self.assertEqual(set(out), {63221, 741158, 2665953, 1425170, 2813599})

        out = ncbi.get_descendant_taxa(
            "9596", intermediate_nodes=False, rank_limit="species"
        )
    ...
    def test_get_topology(self):
        ...
        # Test taxid synonyms
        self.assertEqual(
            ncbi.get_topology(["42099"]).write(format_root_node=True), "1223560;"
        )
    ...
    def test_merged_id(self):
        ...
        self.assertEqual(
            t1, [1, 131567, 2, 1783272, 1239, 186801, 186802, 186803, 207244, 649756]
        )
        t2 = ncbi.get_lineage("649756")
        self.assertEqual(
            t2, [1, 131567, 2, 1783272, 1239, 186801, 186802, 186803, 207244, 649756]
        )
